...
const projectData = [
    {title: "AI JobAnalyzer", 
        ...
        description:"An tool for real-time job market insights and AI generated charts and analytics. Allows users to aggregate data from sources like Indeed and LinkedIn. Users can then instantly uncover trends and patterns by asking direct questions about the dataset—ushering in a future where insights are just a question away. No more Excel or Python Pandas."},
    {title: "Santassign",
        gif: santassignGIF,
        linkText: "Try it out",
        link:"https://santassign.web.app/",
        description: "A beautiful Secret Santa app that spreads holiday cheer by automatically emailing santa assignments to friends. Built on a serverless architecture with AWS Lambda for efficient, reliable email delivery, and a festive front end crafted in React and SCSS to immerse users in the holiday spirit."},
    {title: "+Convez",
        gif: convez,
        linkText: "View Source",
